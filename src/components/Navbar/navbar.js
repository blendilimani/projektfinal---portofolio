...
import './navbar.css';
import logo from '../../assets/17930677-removebg-preview.png';
    ...
    return (
        <nav className="navbar">
         ...
         <div className='navMenu' style={{display: showMenu? 'flex' : 'none'}}>
           ...
           <Link activeClass='active' to='contact' spy={true} smooth={true} offset={-100} duration={500}className='listItem'onClick={()=>setShowMenu(false)}>Contacts</Link>
            </div> 
